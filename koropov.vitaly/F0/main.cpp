...
int main()
{
  ...
  try
  {
    ...
    try
    {
      std::cout << "Пробуем добавить запись с ключом: dictionary.insert(\"\", \"пустота\")...\n";
    ...
    std::cout << "\nТаблица ПЕРЕД критической вставкой (Размер: 4, Емк: 5, Коэффициент: 0.8):\n";
    dictionary.displayTable();
    ...
    std::cout << "3. Пересчитать новые хеш-ин для ВСЕХ старых слов и очистить ячейки [DELETED]\n";
